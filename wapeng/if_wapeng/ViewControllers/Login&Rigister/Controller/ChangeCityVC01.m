...
{
    ChangeCityVC02 * changeCityVC02 = [[ChangeCityVC02 alloc]init];
    
    ChageCityItem * item = [self.provinceArray objectAtIndex:indexPath.row];
    changeCityVC02.cityId = item.mid;
    [self.navigationController pushViewController:changeCityVC02 animated:YES];
}
