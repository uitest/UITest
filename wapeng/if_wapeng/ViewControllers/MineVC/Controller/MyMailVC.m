...
//                    item.recieverID = [[dict objectForKey:@"user"] objectForKey:@"id"];
                    item.recieverID = [dict objectForKey:@"id"];
...
-(void)createComponet{
    ...
    //两个tableView的背景view
    UIScrollView * bgScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, kMainScreenWidth, kMainScreenHeight - 44)];
    bgScrollView.contentSize = CGSizeMake(kMainScreenWidth * 2, kMainScreenHeight - 44 );
    ...
    //粘贴左table
    self.leftTableView = [[UITableView alloc]  initWithFrame:CGRectMake(0, 40,kMainScreenWidth,kMainScreenHeight - 44 - 40)];
