...
//    self.isAnonmity = 1;
    ...
    NSMutableDictionary * postDict = [[NSMutableDictionary alloc]initWithObjectsAndKeys:ddid, @"D_ID", self.mTitle, @"topic.title", [PublicStringTool unifyStringWithAndiordString:self.content], @"topic.content", searchText, @"topic.searchWord", lon, @"topic.longitude", lat, @"topic.latitude", newlimitTime, @"topic.limitTime", flag,@"topic.anonymousFlag",self.placeName,@"topic.placeName",nil];
