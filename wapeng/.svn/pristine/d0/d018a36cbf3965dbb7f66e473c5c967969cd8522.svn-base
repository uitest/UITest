...
#define dNoti_HiddenLeftKeyBoard @"HiddenLeftKeyBoard"
#define dNoti_changBabyClass    @"changBabyClass"
#define dNoti_changeBabyKinder  @"changeBabyKinder"
/*注册模块通知*/
#define dNOti_unique @"unique" //检验手机是否唯一
/**话题详情内容字体大小**/
#define ContentFontSize 16
/**头像圆角参数*/
#define AllCornerRadius 10