...
-(void)createHotWordAndSearchBar
{
...
-(void)createUI
{
    ...
    _tableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, kMainScreenWidth, kMainScreenHeight - 49 -44) style:UITableViewStylePlain];
...
-(void)footerRereshing
{
    ...
    if (self.isButtom == 1) {
        [SVProgressHUD showSuccessWithStatus:@"亲,木有更多内容啦！"];
