...
-(void)createContentView
{
    ...
    self.userLabel.frame = CGRectMake(CGRectGetMinX(_headerImage.frame), CGRectGetMaxY(_headerImage.frame) + 5, 100, 30);
    ...
    self.locationLabel.frame = CGRectMake(self.mainLabel.frame.origin.x + self.mainLabel.frame.size.width + 5 , CGRectGetMinY(_headerImage.frame), 75, 40);
