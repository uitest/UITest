...
//    [YellowView showWithSimpString:@"还是要做"];
    
    NSString * str = @"[看]";
    MyParserTool * tool = [MyParserTool shareInstance];
    
    CGSize size  = [tool sizeWithRawString:str constrainsToWidth:300 Font:[UIFont systemFontOfSize:15]];
    TQRichTextView * textView = [[TQRichTextView alloc]initWithFrame:CGRectMake(10, 200, 300, size.height)];
    textView.text = str;
